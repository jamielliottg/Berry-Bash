...
This Alexa sample skill demonstrates the use of interactive render template directives through multi modal screen design. It can also be used as a template as you can modify the hard coded data to offer choices and information about your chosen data.
