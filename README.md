# Quickly Build A Multi Modal Quiz & Dictionary Skill
...
If you're slightly more advanced or familiar with SMAPI (Skill Management API), jump to the **Setup w/ ASK CLI** section.
